...
public class VolViewEventsNavigation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(VolViewEventsNavigation.this));
            ...
            public void run() {
                ...
                databaseReference.addValueEventListener(new com.google.firebase.database.ValueEventListener() {
                    ...
                    public void onDataChange(com.google.firebase.database.DataSnapshot snapshot) {
                        ...
                        adapter = new RecyclerViewAdapter(VolViewEventsNavigation.this, sortedList);
